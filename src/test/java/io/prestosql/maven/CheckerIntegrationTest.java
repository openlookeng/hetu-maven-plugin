...
public class CheckerIntegrationTest
{
            ...
            throws Exception
    {
        ...
        maven.forProject(basedir)
                .execute("verify")
                .assertLogText("[ERROR] Hetu plugin dependency com.google.guava:guava must not have scope 'provided'.");
    }
            ...
            throws Exception
    {
        ...
        maven.forProject(basedir)
                ...
                .assertLogText("[ERROR] Hetu plugin dependency org.scala-lang:scala-library must not have scope 'provided'.");
    }
            ...
            throws Exception
    {
        ...
        maven.forProject(basedir)
                .execute("verify")
                .assertLogText("[ERROR] Hetu plugin dependency io.airlift:units must have scope 'provided'.");
    }
